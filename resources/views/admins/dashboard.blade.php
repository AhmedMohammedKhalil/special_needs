        ...
        <div class="row item-all-cat">
            <div class="col-xl-4 col-md-6">
                <div class="item-all-card bg-primary">
                    ...
                    <h5 class="text-white">عدد اعضاء هيئة التدريس</h5>
                    <div class="d-flex">
                        ...
                        <div class="item-all-text ms-auto">
                            <h1 class="mb-0 counter font-weight-bold text-white">{{$professors->count()}}</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="item-all-card bg-success">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="item-all-text ms-auto">
                            <h1 class="mb-0 counter font-weight-bold text-white">{{$students->count()}}</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="item-all-card bg-danger">
                    <a href="javascript:void(0)"></a>
                    <h5 class="text-white">عدد الكليات</h5>
                    <div class="d-flex">
                        <div class="iteam-all-icon">
                        ...
                        <div class="item-all-text ms-auto">
                            <h1 class="mb-0 counter font-weight-bold text-white">{{$colleges->count()}}</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="item-all-card bg-purple">
                    <a href="javascript:void(0)"></a>
                    <h5 class="text-white">عدد الطلبات</h5>
                    <div class="d-flex">
                        <div class="iteam-all-icon">
                        ...
                        <div class="item-all-text ms-auto">
                            <h1 class="mb-0 counter font-weight-bold text-white">{{$requests->count()}}</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="item-all-card bg-warning">
                    <a href="javascript:void(0)"></a>
                    <h5 class="text-white">عدد المقابلات</h5>
                    <div class="d-flex">
                        <div class="iteam-all-icon">
                        ...
                        <div class="item-all-text ms-auto">
                            <h1 class="mb-0 counter font-weight-bold text-white">{{$interviews->count()}}</h1>
                        </div>
                    </div>
                </div>
            </div>
