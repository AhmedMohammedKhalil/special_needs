...
<div class="card">
    <div class="card-body p-6">
        <div class="mb-6">
            <h5 class="fs-25 font-weight-semibold text-center">اضافة سبب الرفض</h5>
        </div>
        <div class="single-page customerpage">
            <div class="wrapper wrapper2 box-shadow-0">
                @livewire('professor.request.reject',['request_id'=>$request_id])
            </div>
        </div>
    </div>
