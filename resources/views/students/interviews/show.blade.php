    ...
    <div class="card-body">
        <div id="rootwizard" class="border overflow-hidden br-7 pt-0 ">
            <ul class="nav nav-tabs navtab-wizard p-5 m-0">
                ...
                <li class="nav-item me-1"><a href="#second" data-bs-toggle="tab" class="nav-link font-bold">بيانات عضو هيئة التدريس</a></li>
            ...
            <div class="tab-content card-body mt-3 mb-0 b-0">
                ...
                <div class="tab-pane fade" id="second">
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="profile-log-switch">
                                <div class="media-heading">
                                    <h3 class="card-title mb-3 font-weight-bold">بيانات عضو هيئة التدريس</h3>
                                </div>
                                <ul class="usertab-list">
                                    <li><span class="font-weight-bold text-default-dark float-start">الإسم :
                                            </span> <span class="user-1 ms-2"> {{$interview->professor->name}}</span></li>
                                    <li><span class="font-weight-bold text-default-dark float-start">الموبايل :
                                            </span> <span class="user-1 ms-2"> {{$interview->professor->phone}}</span></li>
                                    <li><span class="font-weight-bold text-default-dark float-start">النوع :
                                            </span> <span class="user-1 ms-2"> {{$interview->professor->gender}}</span></li>
                                </ul>
                ...
                @if($interview->status == "" || $interview->status == "انتظار")
                    <ul class="pager wizard my-4 d-flex justify-content-center border-0">
                        <li class="mx-4"><a href="{{ route('student.interview.accept',['id' => $interview->id]) }}" class="btn btn-success mb-0">موافق</a></li>
                        <li class="mx-4"><a href="{{ route('student.interview.reject',['id' => $interview->id]) }}" class="btn btn-danger mb-0">رفض</a></li>
                    </ul>
                @endif
            </div>
        </div>
