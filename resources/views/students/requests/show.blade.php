                    ...
                    <div class="card-body">
                        <div class="profile-log-switch">
                            ...
                            <ul class="usertab-list">
                                ...
                                <a target="_blank" href="{{ route('student.request.showFile',['id' => $request->id]) }}" class="btn btn-success mb-0">عرض</a>
                                <a target="_blank" href="{{ route('student.request.downloadFile',['id' => $request->id]) }}" class="btn btn-primary mb-0">تحميل</a>
